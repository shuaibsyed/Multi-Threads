...
/* DO NOT CONVERT THIS PROGRAM- IN THIS FILE- TO A THREADED ONE.  IF YOU DO
 * IT WILL NOT PASS ANY TESTS.  LIKE THE PROJECT ASSIGNMENT SAYS, **COPY**
 * THIS FILE TO ONE NAMED wc-threaded.c, THEN MODIFY ***THAT*** ONE BY
 * MAKING IT THREADED.  (YOUR THREADED PROGRAM MUST BE NAMED wc-threaded.c.)
 */
